...
Invalid calendar dates such as `2024-02-30`, `April 31st, 2024`, and `2027-06-40` must be corrected by adding the excess days to the last day of the correct month, resulting in a date in the following month.

Examples:

- `2024-02-30` has one day more than it should, as the month ends on the 29th. Adding one more day results in the correct date: `2024-03-01`.
- `April 31st, 2024` also has one extra day; therefore, the corrected date should be `2024-05-01`.
- `2027-06-40` has ten days more than it should; therefore, the corrected date should be `2027-07-10`.
...
After processing, generate an .xlsx file named `porsche_data_base_sanitize.xlsx` and create a Python script for use with larger datasets.